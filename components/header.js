      ...
      <div className="header-center">
        ...
        <div className="ruler"></div>
          {/*<a data-toggle="modal" data-target="#messageModal" className="text-white btn btn-outline-light btn-lg bold-outline-btn">Join a party</a>*/}
           <a href="https://ust.az1.qualtrics.com/jfe/form/SV_6YBNQDgOo3P5DZc" target="_blank" className="text-white btn btn-outline-light btn-lg bold-outline-btn">Join a party</a>
      </div>
      <style jsx>{`
        .bold-outline-btn {
          border-radius: 8pt;
